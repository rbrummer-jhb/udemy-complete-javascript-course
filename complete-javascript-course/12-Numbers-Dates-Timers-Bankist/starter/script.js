...
/*
// Numbers are represented internally as 64 bits (64 1s and 0s).
// Only 53 bits are used for storing the digits themselves,
// the rest are used for storing the position of the decimal point and the sign.
console.log(2 ** 53 - 1);
console.log(Number.MAX_SAFE_INTEGER);

// Any number larger than the MAX_SAFE_INTEGER cannot be accurately represented.
console.log(2 ** 53 + 1);
console.log(2 ** 53 + 2);
console.log(2 ** 53 + 3);
console.log(2 ** 53 + 4);

console.log(BigInt(457358735614351346));
...
// console.log(new Date('Aug 06 2021 13:26:09'));
...
console.log(new Date(1628249593042));
*/
...
console.log('ZA: ', new Intl.NumberFormat('en-ZA', options).format(num));
